...
<?php while (have_posts()) : the_post(); ?>
    ...
    <?php if (get_the_content()) : ?>
        <div class="container mt-20p mx-auto">
            <div class="entry-content text-dark"><?php the_content(); ?></div>
        </div>
    <?php endif; ?>
...
<?php
// On page templates WordPress uses the 'page' query var for pagination
        ...
        <ul class="blog-filter__tabs nav" role="tablist">
            <li class="nav-item" role="presentation">
                <button
                    ...
                    aria-selected="true"><?php esc_html_e('All'); ?></button>
            </li>
