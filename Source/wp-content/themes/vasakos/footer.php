                    ...
                    <div class="footer-content d-flex align-items-center justify-content-center">
                        ...
                        <div class="copywrite-text text-white">
                            <p class="text-white text-center copyright" style="font-size: 15px;">
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved Vasileios Vasakos | Made with <i class="fa fa-heart pulse"></i> by Thomas Gerasis
                             </p>
                        </div>
                    </div>
                </div>
...
<script defer type="text/javascript" src="<?php echo get_template_directory_uri().'/assets/js/masonry.pkgd.min.js'; ?>"></script>
<script defer src="<?php echo get_template_directory_uri().'/assets/js/bootstrap.min.js'; ?>"></script>
<script defer src="<?php echo get_template_directory_uri().'/assets/js/alime.bundle.js'; ?>"></script>
<script defer src="<?php echo get_template_directory_uri().'/assets/js/jquery.magnific-popup.min.js'; ?>"></script>
